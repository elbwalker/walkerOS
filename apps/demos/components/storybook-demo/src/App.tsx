...
function App() {
  const [currentTemplate, setCurrentTemplate] = useState<TemplateType>('landing');
    ...
    return (
      <div style={{ 
        ...
        <div style={{ maxWidth: '600px' }}>
          <Typography variant="h1" style={{ marginBottom: '16px', color: 'white' }}>
            Component Demo
          </Typography>
          <Typography variant="body1" style={{ marginBottom: '32px', color: 'rgba(255,255,255,0.9)' }}>
            Explore two complete application domains built with Atomic Design principles
          </Typography>
          ...
          <div style={{
            ...
            <Typography variant="h4" style={{ marginBottom: '12px', color: 'white' }}>
              🎯 For the Full Experience
            </Typography>
            <Typography variant="body2" style={{ color: 'rgba(255,255,255,0.8)' }}>
              Run <code style={{ background: 'rgba(0,0,0,0.2)', padding: '2px 6px', borderRadius: '4px' }}>npm run storybook</code> to explore all components in detail with interactive documentation
            </Typography>
          </div>
        </div>
      </div>
