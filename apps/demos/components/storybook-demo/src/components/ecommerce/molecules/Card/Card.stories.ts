...
export const Default: Story = {
  args: {
    title: 'Card Title',
    description: 'This is a simple card component that can display content with an optional action button.',
...
export const WithImage: Story = {
  args: {
    ...
    description: 'A stunning view of mountains and valleys captured in this beautiful photograph.',
