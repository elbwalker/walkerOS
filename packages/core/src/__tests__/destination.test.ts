import type { Destination, WalkerOS } from '../types';
import { clone, createEvent } from '..';
...
describe('Destination', () => {
  ...
  describe('DryRun Configuration Scenarios', () => {
    ...
    beforeEach(() => {
      mockWrapperFn = jest.fn(() => 'original-result');
      onCall = jest.fn();
    });
    ...
    test('should handle multiple destinations with different dryRun settings', async () => {
      ...
      const mockWrapperFn1 = jest.fn(() => 'original-result-1');
      const mockWrapperFn2 = jest.fn(() => 'original-result-2');
      const mockWrapperFn3 = jest.fn(() => 'original-result-3');
    ...
    test('should pass dryRun to wrapper in destinationInit context', async () => {
      const mockInitWrapper = jest.fn(() => 'init-result');
    ...
    test('should pass dryRun to wrapper in batch context', async () => {
      const mockBatchWrapper = jest.fn(() => 'batch-result');
