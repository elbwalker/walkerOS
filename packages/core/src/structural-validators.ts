// Codegen-time structural validators. They run on their own WITHOUT loading
// esbuild or fetching any package/archive. The CLI bundler runs these before
// the esbuild compile; deploy preflight reuses them via
