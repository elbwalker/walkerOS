        ...
        switch (action) {
          case 'deploy': {
            ...
            return mcpResult(result, {
              next: ['Use deploy with action "get" to check deployment status'],
            });
          }
          ...
          case 'get': {
            if (!id) {
              return mcpError(
                new Error(
                  'id is required for get action. Use deploy with action "list" to see available deployments.',
                ),
              );
            }
            try {
          ...
          case 'delete': {
            if (!id) {
              return mcpError(
                new Error(
                  'id is required for delete action. Use deploy with action "list" to see available deployments.',
                ),
              );
            }
