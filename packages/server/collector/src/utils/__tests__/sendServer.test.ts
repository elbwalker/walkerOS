...
describe('sendServer', () => {
  ...
  test('http request', async () => {
    const response = await sendServer(urlHttp, data);
  ...
  test('https request', async () => {
    await sendServer(urlHttps, data);
  ...
  test('on error', async () => {
    const response = await sendServer(urlBroken, data);
  ...
  test('on timeout', async () => {
    ...
    const responsePromise = sendServer(urlTimeout, data, {
      timeout: 1000,
    });
