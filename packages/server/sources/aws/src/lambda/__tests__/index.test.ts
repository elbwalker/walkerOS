...
describe('sourceLambda', () => {
  ...
  describe('example-based tests', () => {
    ...
    const apiGatewayV2PostEvent: APIGatewayProxyEventV2 = {
      version: '2.0',
      routeKey: '$default',
      rawPath: '/collect',
      rawQueryString: '',
    ...
    const apiGatewayV2GetEvent: APIGatewayProxyEventV2 = {
      version: '2.0',
      routeKey: '$default',
      rawPath: '/collect',
    ...
    const apiGatewayV1PostEvent: APIGatewayProxyEvent = {
      httpMethod: 'POST',
      path: '/collect',
      body: JSON.stringify({
        event: 'product add',
    ...
    it('processes v2 POST event correctly', async () => {
      ...
      const result = await source.push(apiGatewayV2PostEvent, context);
    ...
    it('handles GET pixel tracking', async () => {
      ...
      const result = await source.push(apiGatewayV2GetEvent, context);
    ...
    it('handles v1 POST event', async () => {
      ...
      const result = await source.push(apiGatewayV1PostEvent, context);
