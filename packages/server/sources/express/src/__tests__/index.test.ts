...
describe('sourceExpress', () => {
  ...
  describe('process.env.PORT override', () => {
    ...
    it('should use process.env.PORT over config.settings.port', async () => {
      ...
      expect(source.config.settings?.port).toBe(9999);
    ...
    it('should start server when only process.env.PORT is set', async () => {
      ...
      expect(source.config.settings?.port).toBe(0);
      expect(source.server).toBeDefined();
      expect(source.server?.listening).toBe(true);
    ...
    it('should use config.settings.port when process.env.PORT is not set', async () => {
      delete process.env.PORT;
