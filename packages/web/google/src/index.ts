...
export * as destinationAdsExamples from './ads/examples';

// Google Analytics 4
export { destinationGA4 } from './ga4';
export * as DestinationGA4 from './ga4/types';
export * as destinationGA4Examples from './ga4/examples';

// Google Tag Manager
export { destinationGTM } from './gtm';
export * as DestinationGTM from './gtm/types';
export * as destinationGTMExamples from './gtm/examples';
