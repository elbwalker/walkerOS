---
name: using-walkeros-cli
description:
  Use when bundling flows, testing events with simulate/push, running local
  servers, validating configs, or configuring Flow.Setup JSON files.
---
