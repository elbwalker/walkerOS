...
export declare namespace ITagger {
    interface Config {
        prefix: string;
    }
    interface Function {
        ...
        property: (entity: string, prop: string, value: Walker.Property) => Walker.Properties;
    ...
    type Trigger = 'click' | 'hover' | 'load' | 'pulse' | 'submit' | 'visible' | 'wait';
}
declare function Tagger(config?: Partial<ITagger.Config>): ITagger.Function;
