...
We've built the [walker.js](/docs/collectors/web-collector/) to support this new
approach of event tracking. The combination of an attributed-based tracker and
the new event concept makes tracking implementation with elbwalker so **easy,
fast and natural** .
