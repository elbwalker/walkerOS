...
authors:
  name: nicolas
  image_url: /img/author/nicolas.jpeg
...
banner click triggered by a user. Check out our
[docs](https://github.com/elbwalker/walker.js/blob/main/README.md) if you are
not too familiar with how the walker.js works.
