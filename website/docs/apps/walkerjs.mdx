...
import { schemas } from '@walkeros/walker.js';

export const walkerjsSettingsSchema = schemas.settings;
export const browserConfigSchema = schemas.browserConfig;
export const dataLayerConfigSchema = schemas.dataLayerConfig;
export const collectorConfigSchema = schemas.collectorConfig;
...
<PropertyTable schema={walkerjsSettingsSchema} />

#### Browser Source Settings

<PropertyTable schema={browserConfigSchema} />

#### DataLayer Settings

<PropertyTable schema={dataLayerConfigSchema} />

#### Collector Settings

<PropertyTable schema={collectorConfigSchema} />
