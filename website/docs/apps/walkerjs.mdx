...
import data from '@walkeros/walker.js/walkerOS.json';
...
<PropertyTable schema={data.schemas.browserConfig} />

#### DataLayer settings

<PropertyTable schema={data.schemas.dataLayerConfig} />

#### Collector settings

<PropertyTable schema={data.schemas.collectorConfig} />
...
<CodeSnippet
  ...
  // Session source (default: true)
  session: true, // or session source settings, e.g. { storage: true }
