...
Add a custom destination where push points to console.log to list all events in
the console:
...
Use selectors to loop through all elb-tags on a page and display the results in
the console:
