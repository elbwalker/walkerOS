...
<Tabs>
  <TabItem value="window" label="Window (recommended)" default>
    ...
    ```js
    import { Walkerjs } from '@walkerOS/web-collector';
...
Available&nbsp;<Link to="/docs/getting_started/destinations">destinations</Link> have a special ES5-build that can be used in the GTM.
