...
E.g. you can add a [global attribute](/docs/sources/html-tagging#globals) once
and automatically have it available in every event. walker.js also captures
[additional fields](/docs/collectors/web/) like event timings, consent-state,
...
- **Install walker.js with the tag template:** If you'd like to install
  ...
  [Google Tag Manager tag template](/docs/collectors/web/installation/gtm/)

- **Use GTM destination:** If you'd like to use
  [walker.js](/docs/collectors/web/) as an event source while keeping GTM for
