...
The verification scripts compose with turbo cache and the `[origin/main]`
filter. For day-to-day work, prefer `verify:touched` for the package you
edited and `verify:affected` before opening a PR. Save the full root-level
runs for release prep.
