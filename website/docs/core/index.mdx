...
<CodeBox code={`import { assign, anonymizeIP, getMappingValue } from '@walkeros/core';`} disabled language="typescript" label="Code Example" showHeader={false} autoHeight={{ min: 100, max: 600 }} />
