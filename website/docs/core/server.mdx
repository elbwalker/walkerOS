...
<CodeBox code={`import { sendServer, getHashServer } from '@walkeros/server-core';`} disabled language="typescript" label="Code Example" showHeader={false} autoHeight={{ min: 100, max: 600 }} />
