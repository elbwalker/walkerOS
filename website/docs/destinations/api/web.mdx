...
export const destination = { ...destinationWebAPI, examples: data.examples };
...
<DestinationDemo
  ...
  smallText={true}
  height={'128px'}
  event={data.examples.step.entityAction.in}
  mapping={data.examples.step.entityAction.mapping}
  generic={true}
/>
