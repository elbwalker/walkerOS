...
(see&nbsp;<Link to="/docs/collectors/web/commands#destination">walker.js</Link>
or&nbsp;<Link to="/docs/collectors/server/commands#destination">server</Link>).
...
flowchart LR
  ...
  webD & serverD --> tools
  click webC "/docs/collectors/web/"
  click serverC "/docs/collectors/server/"
...
Like&nbsp;<Link to="/docs/collectors/web">walker.js</Link>, web destinations run
in the **browser** directly. Their purpose is to initialize, map event data to
the vendors' requirements, and send them.
