...
import { destinationMetaExamples } from '@walkerOS/node-destination-meta/examples';

<PackageLink github="packages/node/destinations/meta" npm="@walkerOS/node-destination-meta" />
...
- walkerOS&nbsp;<Link to="/docs/collectors/node-collector">node collector</Link> installed
...
```sh
npm install @walkerOS/node-destination-meta
```
