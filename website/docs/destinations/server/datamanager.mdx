...
---
import { schemas } from '@walkeros/server-destination-datamanager/schemas';
...
elb('walker destination', destinationDataManager, {
  settings: {
...
<CodeSnippet
  code={`elb('walker destination', destinationDataManager, {
  settings: {
    accessToken: 'ya29.c.xxx',
    destinations: [...],
