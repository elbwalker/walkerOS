---
title: Piwik PRO
description: "Server-side event delivery to the Piwik PRO Tracking API, reusing web destination mappings that use the portable methods"
...
- An event that is not a page view and whose rule has neither `name` nor `goalId`.
