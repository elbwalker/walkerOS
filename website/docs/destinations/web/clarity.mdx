...
import { examples, schemas } from '@walkeros/web-destination-clarity/dev';

export const destination = { ...destinationClarity, examples };
...
<DestinationDemo
  destination={destination}
  settings={{ apiKey: '3t0wlogvdz' }}
  event={examples.step.productViewWithTags.in}
  mapping={examples.step.productViewWithTags.mapping}
  generic={true}
/>
...
<DestinationDemo
  destination={destination}
  settings={{ apiKey: '3t0wlogvdz' }}
  event={examples.step.orderCompleteInclude.in}
  mapping={examples.step.orderCompleteInclude.mapping}
  generic={true}
/>
...
<DestinationDemo
  destination={destination}
  settings={{ apiKey: '3t0wlogvdz' }}
  event={examples.step.orderCompleteUpgrade.in}
  mapping={examples.step.orderCompleteUpgrade.mapping}
  generic={true}
/>
