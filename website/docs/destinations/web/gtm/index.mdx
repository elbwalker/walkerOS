...
import { destinationGTMExamples } from '@walkerOS/web-destination-gtm/examples';
...
<PackageLink
  browser="@walkerOS/web-destination-gtm"
  es5="@walkerOS/web-destination-gtm"
  github="packages/web/destinations/gtm"
  npm="@walkerOS/web-destination-gtm"
/>
...
<script>
  ...
  const destination = (
    await import(
      'https://cdn.jsdelivr.net/npm/@walkerOS/web-destination-gtm/dist/index.mjs'
    )
  ).destinationGTM;
...
Copy the code from the&nbsp;<Link to="https://cdn.jsdelivr.net/npm/@walkerOS/web-destination-gtm@latest/dist/index.browser.js">index.browser.js</Link> file
...
<DestinationPush
  ...
  mapping={destinationGTMExamples.mapping.add_to_cart}
/>
...
<DestinationPush
  ...
  mapping={destinationGTMExamples.mapping.purchase}
/>
