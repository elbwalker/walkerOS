...
Walker.js is meant to be <b>vendor-agnostic</b>. We actually encourage you to
use different tools for different purposes. But we also encourage you to
minimize the instrumentation effort and use walker.js as a <b>universal
