...
import { examples, schemas } from '@walkeros/web-destination-linkedin/dev';

export const destination = { ...destinationLinkedIn, examples };
...
submissions, signups, downloads — anything that's a one-shot Conversion Rule.

<DestinationDemo
  destination={destination}
  settings={{ apiKey: '123456' }}
  event={examples.step.simpleConversionId.in}
  mapping={examples.step.simpleConversionId.mapping}
  generic={true}
/>
...
<DestinationDemo
  destination={destination}
  settings={{ apiKey: '123456' }}
  event={examples.step.orderCompleteFullConversion.in}
  mapping={examples.step.orderCompleteFullConversion.mapping}
  generic={true}
/>
...
<DestinationDemo
  destination={destination}
  settings={{ apiKey: '123456' }}
  event={examples.step.pageViewConversion.in}
  mapping={examples.step.pageViewConversion.mapping}
  generic={true}
/>
...
quick reactivation — useful for A/B testing which conversions fire or pausing
...
<DestinationDemo
  destination={destination}
  settings={{ apiKey: '123456' }}
  event={examples.step.conversionSkipped.in}
  mapping={examples.step.conversionSkipped.mapping}
  generic={true}
/>
