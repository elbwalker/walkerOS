...
export const destination = { ...destinationLinkedIn, examples: data.examples };
...
<DestinationDemo
  ...
  event={data.examples.step.simpleConversionId.in}
  mapping={data.examples.step.simpleConversionId.mapping}
  generic={true}
/>
...
<DestinationDemo
  destination={destination}
  settings={{ apiKey: '123456' }}
  event={data.examples.step.orderCompleteFullConversion.in}
  mapping={data.examples.step.orderCompleteFullConversion.mapping}
  generic={true}
/>
...
<DestinationDemo
  destination={destination}
  settings={{ apiKey: '123456' }}
  event={data.examples.step.pageViewConversion.in}
  mapping={data.examples.step.pageViewConversion.mapping}
  generic={true}
/>
...
<DestinationDemo
  destination={destination}
  settings={{ apiKey: '123456' }}
  event={data.examples.step.conversionSkipped.in}
  mapping={data.examples.step.conversionSkipped.mapping}
  generic={true}
/>
