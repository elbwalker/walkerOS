...
import { examples, schemas } from '@walkeros/web-destination-meta/dev';

export const destination = { ...destinationMetaPixel, examples };
...
<DestinationDemo
  ...
  smallText={true}
  height={'512px'}
  event={examples.step.viewContent.in}
  mapping={examples.step.viewContent.mapping}
  generic={true}
/>
...
<DestinationDemo
  ...
  smallText={true}
  height={'512px'}
  event={examples.step.initiateCheckout.in}
  mapping={examples.step.initiateCheckout.mapping}
  generic={true}
/>
