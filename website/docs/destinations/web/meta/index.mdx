...
import { destinationMetaPixelExamples } from '@walkerOS/web-destination-meta/examples';
...
<PackageLink
  browser="@walkerOS/web-destination-meta"
  es5="@walkerOS/web-destination-meta"
...
```bash
npm i @walkerOS/web-destination-meta
```
...
<script>
  ...
  const destination = (
    await import(
      'https://cdn.jsdelivr.net/npm/@walkerOS/web-destination-meta/dist/index.mjs'
    )
  ).default;
...
Copy the code from the&nbsp;<Link to="https://cdn.jsdelivr.net/npm/@walkerOS/web-destination-meta@latest/dist/index.browser.js">index.browser.js</Link> file
...
<DestinationPush
  ...
  mapping={destinationMetaPixelExamples.mapping.ViewContent}
/>
...
<DestinationPush
  ...
  mapping={destinationMetaPixelExamples.mapping.AddToCart}
/>
...
<DestinationPush
  ...
  mapping={destinationMetaPixelExamples.mapping.InitiateCheckout}
/>
...
<DestinationPush
  ...
  mapping={destinationMetaPixelExamples.mapping.Purchase}
/>
