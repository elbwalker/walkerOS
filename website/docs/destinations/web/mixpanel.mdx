...
export const destination = { ...destinationMixpanel, examples: data.examples };
...
<DestinationDemo
  destination={destination}
  settings={{ apiKey: 'mp_test' }}
  event={data.examples.step.userLoginIdentifyAndPeople.in}
  mapping={data.examples.step.userLoginIdentifyAndPeople.mapping}
  generic={true}
/>
...
<DestinationDemo
  destination={destination}
  settings={{ apiKey: 'mp_test' }}
  event={data.examples.step.profileUpdateAllPeopleOperations.in}
  mapping={data.examples.step.profileUpdateAllPeopleOperations.mapping}
  generic={true}
/>
...
<DestinationDemo
  destination={destination}
  settings={{ apiKey: 'mp_test' }}
  event={data.examples.step.userGroupAssociation.in}
  mapping={data.examples.step.userGroupAssociation.mapping}
  generic={true}
/>
...
<DestinationDemo
  destination={destination}
  settings={{ apiKey: 'mp_test' }}
  event={data.examples.step.companyUpdateGroupProfile.in}
  mapping={data.examples.step.companyUpdateGroupProfile.mapping}
  generic={true}
/>
