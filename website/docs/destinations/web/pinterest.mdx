...
export const destination = { ...destinationPinterest, examples: data.examples };
...
<DestinationDemo
  ...
  event={data.examples.step.pageViewRename.in}
  mapping={data.examples.step.pageViewRename.mapping}
  generic={true}
/>
...
<DestinationDemo
  destination={destination}
  settings={{ apiKey: '2612345678901' }}
  event={data.examples.step.orderCompleteCheckout.in}
  mapping={data.examples.step.orderCompleteCheckout.mapping}
  generic={true}
/>
...
<DestinationDemo
  destination={destination}
  settings={{ apiKey: '2612345678901' }}
  event={data.examples.step.userLoginLead.in}
  mapping={data.examples.step.userLoginLead.mapping}
  generic={true}
/>
...
<DestinationDemo
  destination={destination}
  settings={{ apiKey: '2612345678901' }}
  event={data.examples.step.identifyOnlySkip.in}
  mapping={data.examples.step.identifyOnlySkip.mapping}
  generic={true}
/>
