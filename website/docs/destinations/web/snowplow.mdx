...
export const destination = { ...destinationSnowplow, examples: data.examples };
...
Track video and audio playback events using Snowplow's [media tracking data.schemas](https://docs.snowplow.io/docs/collecting-data/collecting-from-own-applications/javascript-trackers/web-tracker/tracking-events/media/). The destination supports all media events and contexts.
...
// Consent data.schemas (Enhanced Consent plugin)
...
<DestinationDemo
  ...
  smallText={true}
  height={'512px'}
  event={data.examples.step.productView.in}
  mapping={data.examples.step.productView.mapping}
  generic={true}
  initFirst={true}
/>
...
<DestinationDemo
  ...
  smallText={true}
  height={'512px'}
  event={data.examples.step.addToCart.in}
  mapping={data.examples.step.addToCart.mapping}
  generic={true}
  initFirst={true}
/>
...
<DestinationDemo
  ...
  smallText={true}
  height={'512px'}
  event={data.examples.step.transaction.in}
  mapping={data.examples.step.transaction.mapping}
  generic={true}
  initFirst={true}
/>
...
<DestinationDemo
  ...
  smallText={true}
  height={'512px'}
  event={data.examples.step.promoView.in}
  mapping={data.examples.step.promoView.mapping}
  generic={true}
  initFirst={true}
/>
