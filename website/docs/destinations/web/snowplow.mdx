...
<DestinationDemo
  ...
  smallText={true}
  height={'512px'}
  event={examples.step.productView.in}
  mapping={examples.step.productView.mapping}
  generic={true}
/>
...
<DestinationDemo
  ...
  smallText={true}
  height={'512px'}
  event={examples.step.addToCart.in}
  mapping={examples.step.addToCart.mapping}
  generic={true}
/>
...
<DestinationDemo
  ...
  smallText={true}
  height={'512px'}
  event={examples.step.transaction.in}
  mapping={examples.step.transaction.mapping}
  generic={true}
/>
...
<DestinationDemo
  ...
  smallText={true}
  height={'512px'}
  event={examples.step.promoView.in}
  mapping={examples.step.promoView.mapping}
  generic={true}
/>
