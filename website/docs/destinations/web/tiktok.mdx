...
import { examples, schemas } from '@walkeros/web-destination-tiktok/dev';

export const destination = { ...destinationTikTok, examples };
...
<DestinationDemo
  destination={destination}
  settings={{ apiKey: 'C4XXXXXXXXXXXXXXXXXXX' }}
  event={examples.step.userRegisterCompleteRegistration.in}
  mapping={examples.step.userRegisterCompleteRegistration.mapping}
  generic={true}
/>
...
<DestinationDemo
  destination={destination}
  settings={{ apiKey: 'C4XXXXXXXXXXXXXXXXXXX' }}
  event={examples.step.orderCompleteCompletePayment.in}
  mapping={examples.step.orderCompleteCompletePayment.mapping}
  generic={true}
/>
...
<DestinationDemo
  destination={destination}
  settings={{ apiKey: 'C4XXXXXXXXXXXXXXXXXXX' }}
  event={examples.step.searchSubmitSearch.in}
  mapping={examples.step.searchSubmitSearch.mapping}
  generic={true}
/>
...
<DestinationDemo
  ...
  event={examples.step.destinationLevelIdentify.in}
  generic={true}
/>
...
(per-event) overrides for one push — useful for signup and checkout flows
