      ...
      "config": {
        ...
        "bundle": {
          "packages": {
            ...
            "@walkeros/web-destination-amplitude": { "version": "^4" },
            "@walkeros/web-destination-mixpanel": { "version": "^4" },
            "@walkeros/web-destination-posthog": { "version": "^4" }
          }
        }
      },
      "sources": {
...
<CodeSnippet
  code={`gtag('event', 'order_complete', { send_to: 'G-XXXXXXXXXX' })
