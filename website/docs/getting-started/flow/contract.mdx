...
<FlowSlice feature="contract-default" depth={1} />

<FlowSlice feature="contract-description" />

<FlowSlice feature="contract-tagging" />
...
<FlowSlice feature="contract-schema" />
...
<FlowSlice feature="contract-events" depth={2} />

<FlowSlice feature="contract-wildcard" />
...
<FlowSlice feature="contract-extend" />

<FlowSlice feature="contract-server-hash" />
...
- A key outside `extend`, `tagging`, `description`, `events`, `schema` is a warning, not an error
...
[Validate](/docs/transformers/validate#reference-a-contract)). For
