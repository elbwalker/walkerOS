...
- **Vendor Independence** — One tracking implementation, any destination
- **Privacy-First** — Consent and policy controls built in
- **Type-Safe** — TypeScript catches errors at compile time
- **Composable** — Mix sources, destinations, and mappings freely
- **Testable** — Simulate events, version configs, review in PRs
