...
This example demonstrates how to implement GDPR/CCPA compliant tracking with
proper consent state management. Essential for any website that needs to respect
user privacy preferences.

## What You'll Learn

- Setting up consent-aware tracking
- Managing consent states (accept/reject/customize)
- Conditional event sending based on consent
...
```bash
npm install @walkerOS/collector @walkerOS/destination-web-gtag @walkerOS/destination-web-meta
```
...
1. Copy the consent management code
2. Integrate with your consent banner solution
3. Test different consent scenarios:
   - Accept all cookies
   - Reject all cookies
   - Customize preferences
4. Verify events are only sent when consent allows
5. Check that consent state persists across page loads

This implementation ensures your walkerOS tracking respects user privacy choices
and complies with international privacy regulations.
