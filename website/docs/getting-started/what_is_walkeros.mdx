...
captures, structures, queues, and routes events with built-in support for
consent management — all directly in your code. No fragile UI configs. No
black-box logic. Just tracking you can **version, test, and trust**.

The project started as the lightweight web tracking library walker.js, and has
