...
While&nbsp;<Link to="/docs/getting_started/sources">sources</Link> create events, destinations
...
or&nbsp;<Link to="/docs/collectors/node-collector/commands#destination">node</Link>). Before
...
Like&nbsp;<Link to="/docs/collectors/web-collector">walker.js</Link>, web destinations
