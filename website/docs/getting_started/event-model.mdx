...
<Link to="/docs/sources/html-tagging#data">Data properties</Link>
...
<Link to="/docs/sources/html-tagging#context">Context</Link> refers to the
...
<Link to="/docs/sources/html-tagging#globals">Globals</Link> describe the
...
The&nbsp;<Link to="/docs/sources">source</Link> is the **origin** of the event,
including type (web, app, server), specific site or component, and referrer
information for basic journey attribution.
