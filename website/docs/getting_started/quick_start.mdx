...
- <Link to="/docs/collectors/web-collector/installation">
    {' '}
    Web (Client-side)
  </Link>
- <Link to="/docs/collectors/node-collector/installation">
    Node (Server-side)
  </Link>
...
- Add
  more&nbsp;<Link to="/docs/getting_started/destinations">destinations</Link>
