...
which&nbsp;<Link to="/docs/sources">source</Link> you want to send data from and
which&nbsp;<Link to="/docs/destinations">destination</Link> you want to send it.
...
- <Link to="/docs/collectors/web/installation"> Web (Client-side)</Link>
- <Link to="/docs/collectors/server/installation">Server-side</Link>
...
- Add more&nbsp;<Link to="/docs/destinations">destinations</Link>
