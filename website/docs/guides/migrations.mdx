...
### Option 2: Using createDestination (New)
...
**Benefits of createDestination:**
- Creates fresh destination instances (no config side-effects)
- Enables cleaner single-config-file setups
