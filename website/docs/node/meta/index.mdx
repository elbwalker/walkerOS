...
// TODO import { destinationMetaExamples } from '@walkerOS/node-meta';
...
<LiveCode
  ...
  disableInput={true}
  input={destinationMetaExamples.InitUserData}
  output={`sendNode('https://graph.facebook.com/v22.0/${destinationMetaExamples.InitUserData.pixelId}/events?access_token=${destinationMetaExamples.InitUserData.accessToken}', {
    data: [
      {
