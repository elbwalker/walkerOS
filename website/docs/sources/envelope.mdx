...
pixel exists for the no-JS path where one event is the whole point.

On the AWS Lambda and Cloud Functions sources, `settings.enablePixelTracking:
false` answers 405 instead. The Express and Fetch sources control this through
