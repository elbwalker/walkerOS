...
HTTP event collection for server-side deployments:

* Express - Standalone HTTP server or Express app integration
* Fetch - Edge/serverless platforms (Cloudflare Workers, Vercel Edge, Deno, Bun)
* AWS Lambda - API Gateway and Lambda Function URLs
* GCP Cloud Functions - Google Cloud HTTP triggers
