...
- <Link to="/docs/collectors/web-collector/">**walker.js (web)**</Link>:
  Designed for client-side web applications, SPAs, and websites
- <Link to="/docs/collectors/node-collector/">**node (server)**</Link>: Perfect
  for server-side applications, microservices, and serverless functions
