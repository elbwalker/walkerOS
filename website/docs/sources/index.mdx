...
Sources can implement an optional `on` method to react to collector events. This enables responsive behavior to consent changes, session updates, and collector state without polling.
