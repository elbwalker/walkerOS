...
|---------|------|----------|---------|-------------|
| `maxSize` | `number` | No | `10485760` (10 MB) | Maximum total size in bytes before LRU eviction |
| `maxEntries` | `number` | No | — | Maximum number of entries before oldest is evicted |
