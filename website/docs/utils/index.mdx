...
vary from simple functions like&nbsp;<Link to="helper">`getId`</Link> to more
complex ones like&nbsp;<Link to="session">`sessionStart`</Link>. They are used
in walkerOS itself and can be used in custom tracking setups as well.
