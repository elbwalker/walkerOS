...
each&nbsp;<Link to="/docs/getting_started/destinations">destination</Link> individually.
...
used by the&nbsp;<Link to="/docs/getting_started/sources">sources</Link>.
...
primarily used by&nbsp;<Link to="/docs/getting_started/destinations">destinations</Link> to
