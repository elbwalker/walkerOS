...
<PackageLink github="packages/sources/walkerjs" npm="@walkerOS/web-collector" />
<PackageLink github="packages/utils/src/web/session" npm="@walkerOS/utils" />
...
[on consent event](/docs/collectors/web-collector/commands#on) and won't start until a
...
detection gets scheduled via an [on-consent](/docs/collectors/web-collector/commands#on)
