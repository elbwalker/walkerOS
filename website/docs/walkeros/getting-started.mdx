...
called&nbsp;<Link to="/docs/clients/walkerjs/">walker.js</Link> and has evolved
...
Next step is to
start&nbsp;<Link to="/docs/clients/walkerjs/tagging/">tagging</Link> a website
...
the&nbsp;<Link to="/docs/clients/walkerjs/#basic-idea">basic idea</Link> of
tagging.

## Activating

To&nbsp;<Link to="/docs/clients/walkerjs/commands#destinations">add a
