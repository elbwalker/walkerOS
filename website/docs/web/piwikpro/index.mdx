...
<PackageLink
  browser="@walkerOS/web-piwikpro"
  es5="@walkerOS/web-piwikpro"
  github="packages/web/piwikpro"
  npm="@walkerOS/web-piwikpro"
/>
...
```bash
npm i @walkerOS/web-piwikpro
```

```js
import { elb } from '@walkerOS/web';
import { destinationPiwikPro } from '@walkerOS/web-piwikpro';
...
<script>
  ...
  const destination = (
    await import(
      'https://cdn.jsdelivr.net/npm/@walkerOS/web-piwikpro/dist/index.mjs'
    )
  ).default;
...
Copy the code from the&nbsp;<Link to="https://cdn.jsdelivr.net/npm/@walkerOS/web-piwikpro@latest/dist/index.browser.js">index.browser.js</Link> file
...
<DestinationPush
  ...
  mapping={destinationPiwikProExamples.ecommerceProductDetailView}
/>
...
<DestinationPush
  ...
  mapping={destinationPiwikProExamples.ecommerceAddToCart}
/>
...
<DestinationPush
  ...
  mapping={destinationPiwikProExamples.ecommerceCartUpdate}
/>
...
<DestinationPush
  ...
  mapping={destinationPiwikProExamples.ecommerceOrder}
/>
