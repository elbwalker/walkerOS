...
export default function LegalImprintContentEN() {
  return (
    <div className="relative overflow-hidden py-16">
      <div className="relative px-4 sm:px-6 lg:px-8">
        <div className="prose-elbwalker prose prose-lg mx-auto mt-6 text-gray-400">
          ...
          <p>
            Email: hello@elbwalker.com
            <br />
            Phone: +49 15678 350 120
          </p>
          <p>
            <b>Represented by:</b> Alexander Kirtzel, Ayla Prinz
            <br />
            <b>Commercial register:</b> Amtsgericht Hamburg, HRB 156985
            <br />
