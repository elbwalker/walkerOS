...
export default function LegalImprintContentDE() {
  return (
      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        <div className="prose-elbwalker prose prose-lg mx-auto mt-6 text-gray-400">
          ...
          <p>
            ...
            <br />
            Telefon: +49 15678 350 120
          </p>
          <p>
            <b>Vertreten durch:</b> Alexander Kirtzel, Ayla Prinz
            <br />
            <b>Handelsregister:</b> Amtsgericht Hamburg, HRB 156985
            <br />
